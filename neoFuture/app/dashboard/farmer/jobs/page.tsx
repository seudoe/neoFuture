...
import { Briefcase, Plus, X, Users, MapPin, Calendar, Clock, Wrench, IndianRupee, ChevronDown, ChevronUp, User, Phone } from 'lucide-react';
                  ...
                  <div className="flex-1">
                    ...
                    {job.users && (
                      <div className="flex items-center gap-4 mt-3 pt-3 border-t border-gray-100">
                        ...
                        {job.users.phone_number && (
                          <a
                            href={`tel:${job.users.phone_number}`}
                            className="flex items-center gap-1.5 text-sm text-green-700 font-medium hover:text-green-800 transition-colors"
                          >
