...
import {
  BarChart3, ShoppingCart, Package, Handshake,
  User, ClipboardList, Sprout, Star, Menu, X
} from 'lucide-react';
...
export default function BuyerLayout({ children }: { children: React.ReactNode }) {
  ...
  const isOverview = pathname === '/dashboard/buyer/overview';
          ...
          <div className="md:hidden flex items-center justify-between h-14">
            <div className="flex items-center gap-3">
              <button
                ...
                className="p-2 rounded-lg text-gray-600 hover:bg-blue-50 transition-colors"
